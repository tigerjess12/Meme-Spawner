...
const uploadfetch = require('node-fetch'); // Ensure this is imported at the top
const { v4: uuidv4 } = require('uuid'); // Install uuid if not already installed
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await interaction.editReply(`The file "${attachment.name}" has been successfully uploaded to the memes folder.`);
        } catch (error) {
